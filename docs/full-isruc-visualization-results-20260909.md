...
结果目录：[`docs/eeg-architecture-lop/full-isruc-visualizations-v3/`](eeg-architecture-lop/full-isruc-visualizations-v3/)。

## 如何查看

- [原始/标准化波形](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-waveforms.png)
- [去除增益后的典型波形叠加](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-normalized-overlay.png)
- [目标个体频谱](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-spectra.png)
- [epoch RMS 轨迹热图](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-rms-trajectory.png)
- [目标个体距离矩阵](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-subject-distance.png)
- [原始尺度/功率敏感 PCA](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-pca.png)
- [增益不变 PCA](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-pca-gain-invariant.png)
- [适应/评估标签先验](eeg-architecture-lop/full-isruc-visualizations-v3/eeg-drift-labels.png)
- [机器可读摘要](eeg-architecture-lop/full-isruc-visualizations-v3/visualization-summary.json)
