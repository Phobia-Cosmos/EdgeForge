...
`summary.json` is stored in the sibling analysis archive under `/home/undefined/UbuntuData/ai-storage/EdgeForge/eeg-architecture-lop-analysis-20260911/state-conditioned-steering-pilot-20260911/` because the visualization root contains only images and explanations. The organization map is `/home/undefined/UbuntuData/ai-storage/EdgeForge/eeg-architecture-lop-analysis-20260911/organization-manifest.json`.
