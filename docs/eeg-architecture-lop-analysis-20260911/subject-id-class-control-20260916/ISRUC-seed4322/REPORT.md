...
A classifier that sees only each sequence's 5-D task-label histogram obtains top-1 `0.0213` (chance `0.0102`). This estimates identity leakage from class composition alone.
...
| --- | ---: | ---: |
| raw_waveform | 0.0166 | 0.0044 |
| eeg_branch | 0.2661 | 0.0564 |
| transformer_layer1 | 0.2591 | 0.0570 |
| classifier_input | 0.1374 | 0.0076 |
