...
The model was random-initialized because no native BrainUICL parameter checkpoint was present. Therefore the plots measure what the architecture preserves from the input before training, not what a trained BrainUICL model has learned.
